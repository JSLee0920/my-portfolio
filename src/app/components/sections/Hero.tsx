    ...
    <section className="flex min-h-screen px-6 pt-12 sm:px-12 md:px-24">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-start justify-center">
        ...
        <p className="mb-12 max-w-2xl leading-relaxed text-zinc-300">
          CS Undergraduate @ Multimedia University (MMU), majoring in Artificial
          Intelligence. Software engineer focused on building scalable systems,
          agentic workflows, and high-performance applications from backend to
          UI.
        </p>
